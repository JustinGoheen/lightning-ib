...
# see https://interactivebrokers.github.io/tws-api/financial_advisor.html
...
class AdvisorMixins(ABC):
    ...
    def _set_group_details(self, group_soup):
        ...
    ...
    def _groups(self):
        group = self.ib.requestFA(AdvisorDataTypes.groups)
    ...
    @property
    def profiles(self):
        profiles = self.ib.requestFA(AdvisorDataTypes.profiles)
        return profiles
